...
%TODO: diese section raus, untersections neu als sections
...
\begin{description}
	...
	\item[Infrastructure] Criteria describing the infrastructural or technological aspects of nanoentities. %TODO discuss better name
...
\begin{enumerate} %TODO is it possible to remove some of the negation?
	...
	\item Do a small amount of use cases require more than one service to be completed?

...
After introducing a broad overview, the next sections describe the introduced concepts in more detail. 
 ...
 \begin{itemize}
 	\item An \textbf{\gls{ERM}} consists of data fields, entities and relationships. The data fields are imported as nanoentitites, the entities and relationships of type composition or inheritance as\textit{ Identity \& Lifecycle Commonality} and relationships of type aggegation as \textit{Semantic Proximity}.
 	...
 	\item \textbf{Compatibilities} can be used to import all coupling criteria of type \textit{Compatability}.
 \end{itemize}
...
\begin{description}
	...
	\item[Scorer] calculates the scores between nanoentities based on the users system specification and coupling criteria.

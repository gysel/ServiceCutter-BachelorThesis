...
\begin{enumerate} 
	\item Does the decomposition comply all constraint criteria?
	\item Does the decomposition combine as few nanoentities with diverging characteristics into one service as possible?

...
In order to provide capabilities a service needs resources. We identified three types of resources which form the building blocks for services:
...
\begin{description}
	...
	\item[Artifacts] A service has ownership over artifacts. An example is a business report which has been built by using operations and data. 
\end{description}
...
%TODO: weglassen?
A service must contain  at least two type of nanoentities to be considered a service. 
Something only providing CRUD\footnote{Create, Read, Update, and Delete} functions on data is considered a database. \newline Something only providing operations is considered a function. \newline

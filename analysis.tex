...
The Service Cutter is based on nanoentities. Therefore Service decomposition for the Service Cutter is simply the act of grouping nanoentities into containers. If a nanoentity is assigned to a Service, the Service becomes the owner and is the only instance allowed to create, update or delete instances of the nanoentities.

...
As not many characteristics resulting in negative scores have been defined for the Cargo Tracking System, the priorities for the criteria \textit{Volatility} and \textit{Change Similarty} have been adjusted from their default value \textit{XS} to \textit{S}. The resulting candidate service cuts by the Girvan-Newman algorithm for 4 services are shown in Figure \ref{fig:dddGirvanNewman}.

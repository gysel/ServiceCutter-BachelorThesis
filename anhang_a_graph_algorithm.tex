...
\begin{table}[H]
	...
	\begin{tabular}{|p{60pt}|p{140pt}|p{130pt}|p{70pt}|}
		...
		\hline
		Girvan–\newline Newman\cite{girvan} & A clustering algorithm working on weighted undirected graphs based on Edge-Betweenness. & Java implementations exist as part of the Jung\cite{jung} framework (only unweighted graphs) and as a plugin\cite{girvanGephi} of the Gephi\cite{gephi} platform. & Positive \\
		\hline	
...
The three algorithms positively assessed are MCL, Girvan-Newman and Epidemic Label Propagation. These algorithms haven been tested and further evaluated as described in Section \ref{sec:algorithms}

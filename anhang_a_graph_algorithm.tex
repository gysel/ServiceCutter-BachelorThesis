...
\begin{table}[H]
	...
	\begin{tabular}{|p{90pt}|p{200pt}|p{130pt}|}
		...
		\hline
		MCL - Markov Cluster Algorithm\cite{mcl} & A clustering algorithm working on weighted undirected graphs. MCL is based on Random Walks with Markov Chains. & Implementations of MCL are available in R and in Java as a plugin of the Gephi\cite{gephi} platform.  \\
		\hline

...
The project specific risk number 6 was repeatedly discussed during project status meetings. Large existing projects may not have properly documented requirements in a machine-readable format. Section \ref{sec:input-adapters} presents the idea of adapters to automatically extract data from existing systems. This approach can mitigate this risk.

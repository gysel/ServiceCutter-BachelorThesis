...
\section{Approach \#3: Constructing Services with a Heuristic Greedy Algorithm}
...
Parallel to finding new approaches we continued to investigate in graph clustering.
...
We furthermore implemented a warning in the Service Cutter should a user provides input leading to the faulty behavior of Girvan-Newman as shown in Figure \ref{fig:girvanNewmanWarning}

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{images/grivanNewmanAlert.png}
	\end{center}
	\caption{Service Cutter shown a warning on faulty Girvan-Newman results.}
